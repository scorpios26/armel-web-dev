        ...
        >
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center max-w-6xl w-full">
            ...
            <div className="text-center lg:text-left space-y-4 order-2 lg:order-1">
                <h1 className="text-5xl lg:text-6xl mb-2 text-center font-orbitron font-light">
                Hi, I'm <span className="dark:text-[#2E186A] font-orbitron font-light">Armel</span>👋
              </h1>
              <p className="font-orbitron text-2xl lg:text-4xl mb-4 text-center">A Web Developer.</p>

              <div className="flex flex-col sm:flex-row gap-4 mt-4 justify-center">
                <button className="px-6 py-3 bg-[#2E186A] text-white text-sm font-semibold rounded-lg shadow hover:bg-purple-950 transition font-orbitron">
                  View Projects
                </button>
                <button className="font-orbitron px-6 py-3 bg-transparent border border-[#2E186A] text-[#2E186A] text-sm font-semibold rounded-lg shadow dark:hover:bg-purple-950 dark:hover:text-white transition">
                  Contact Me
                </button>
              </div>
            </div>
