  ...
  return (
    ...
    >
      ...
      <div className="relative flex items-center justify-center">
        {/* Outer neon ring */}
        <div className="absolute w-60 h-60 rounded-full border-4 border-indigo-500 drop-shadow-[0_0_20px_#6366f1] animate-ping"></div>
        ...
        <div className="absolute w-60 h-60 origin-center animate-spin-slow">
          {/* Dot placed at top center of the circle */}
          <div className="absolute left-1/2 top-0 w-4 h-4 bg-purple-400 rounded-full shadow-[0_0_10px_#a855f7] -translate-x-1/2"></div>
        </div>
      </div>

      {/* Loading text under the circles */}
      <p className="mt-24 text-2xl text-indigo-400 font-orbitron tracking-widest animate-pulse text-center">
        Loading...
      </p>
    </div>
  );
