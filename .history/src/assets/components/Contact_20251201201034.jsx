...
return (
    <section id="contact" className="py-20 min-h-screen">
        ...
        <div className="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
          <div>
            <label htmlFor="first-name" className="block text-sm font-semibold text-left">
              First name
            </label>
            <div className="mt-2.5">
              <input
                ...
                className={`block w-full rounded-md px-3.5 py-2 text-base outline outline-1 placeholder:text-gray-400 focus:outline-2 ${
                            isDarkMode
                            ? "bg-gray-900 text-white outline-gray-700 focus:outline-indigo-400"
