  ...
  return (
    ...
    <div className="relative w-full max-w-6xl mx-auto carousel-container">
      {/* Background */}
        ...
        <div className="absolute top-1/4 left-1/4 w-48 h-48 sm:w-96 sm:h-96 rounded-full blur-3xl"></div>
        <div className="absolute bottom-1/4 right-1/4 w-48 h-48 sm:w-96 sm:h-96 rounded-full blur-3xl"></div>
        </div>

      {/* Progress bar */}
      <div className="absolute top-0 left-0 right-0 h-1rounded-full overflow-hidden z-20">
        <div
