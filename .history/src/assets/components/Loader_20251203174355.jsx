    ...
    >
      ...
      <div className="relative flex items-center justify-center">
        ...
        <div className="absolute w-60 h-60">
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 animate-spin-slow origin-center">
            <div className="absolute -top-28 left-1/2 w-4 h-4 bg-purple-400 rounded-full shadow-[0_0_10px_#a855f7] -translate-x-1/2"></div>
          </div>
        </div>
      </div>

      {/* Loading text under the circles */}
      <p className="mt-10 text-2xl text-indigo-400 font-orbitron tracking-widest animate-pulse text-center">
        Loading...
      </p>
    </div>
  );
