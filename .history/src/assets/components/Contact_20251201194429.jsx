          ...
          <div>
            ...
            <div className="mt-2.5">
              <input
                ...
                className="block w-full rounded-md bg-white dark:bg-gray-900 dark:text-white 
  dark:outline-gray-700 dark:placeholder:text-gray-400 
  dark:focus:outline-indigo-400 px-3.5 py-2 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600"
              />
            </div>
          </div>
          <div>
