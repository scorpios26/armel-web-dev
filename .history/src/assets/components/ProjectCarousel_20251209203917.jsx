...
export default function ProjectCarousel() {
  ...
  const slides = [
    {
      title: "Saladmaster Saudi",
      desc: "Premium Cookware. Healthier Lifestyle",
      img: "/assets/SaladmasterSaudi_Revise.png",
      gradient: "from-violet-500/40 to-purple-500/40",
      url: "https://www.saladmastersaudi.com",
    },
    {
      title: "Jones & Jessa Wedding Website",
      desc: "Wedding website for Jones & Jessa's special day, featuring event details, RSVP, and photo gallery.",
      img: "/assets/Wedding_Revise.png",
      gradient: "from-fuchsia-500/40 to-pink-500/40",
      url: "https://jonesandjessawedding.com/",
    },
    {
      title: "To-do App",
      desc: "Simple To-do application to manage daily tasks efficiently.",
      img: "/assets/Todoapp.png",
      gradient: "from-pink-500/40 to-rose-500/40",
      url: "https://todo-app-theta-gold.vercel.app/",
    },
  ];
  ...
  return (
    <section id="projects" className="relative w-full max-w-6xl mx-auto min-h-screen">
          ...
          return (
            ...
            >
              <div className="w-full h-full p-4 sm:p-8">
                ...
                >
                  <div className="w-full h-full rounded-xl sm:rounded-2xl overflow-hidden relative group cursor-pointer">
                    <img
                      src={slide.img}
                      alt={slide.title}
                    ...
                    <div className="absolute inset-x-0 bottom-0 p-4 sm:p-8 bg-gradient-to-t from-black/80 via-black/40 to-transparent text-left font-orbitron">
