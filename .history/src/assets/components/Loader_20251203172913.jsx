  ...
  return (
    <div
      ...
      className={`fixed inset-0 flex items-center justify-center bg-black/90 dark:bg-black z-[9999]
        ${fadeOut ? "animate-fadeOut pointer-events-none" : "opacity-100"}
      `}
      onAnimationEnd={fadeOut ? onAnimationEnd : undefined}
    >
      <div className="relative flex items-center justify-center">
        {/* Outer neon ring */}
        <div className="absolute w-40 h-40 rounded-full border-4 border-indigo-500 drop-shadow-[0_0_20px_#6366f1] animate-ping"></div>
