        ...
        {slides.map((slide, index) => {
          ...
          return (
            ...
            <div className="w-full h-full rounded-xl sm:rounded-2xl overflow-hidden relative group">
                ...
                <div className="absolute left-0 bottom-0 p-4 sm:p-8 bg-gradient-to-t from-black/80 via-black/40 to-transparent max-w-lg text-left">
                <h3 className="text-white text-xl sm:text-2xl md:text-3xl font-bold mb-2 sm:mb-3">
                    {slide.title}
                </h3>
                <p className="text-gray-200 text-sm sm:text-base md:text-lg font-orbitron">
                    {slide.desc}
                </p>
                </div>
            </div>
