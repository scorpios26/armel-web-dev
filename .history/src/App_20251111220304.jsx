    ...
    {[
      {
        ...
        details: "Part of the API integration team using PHP as backend. Improved coding skills and developed new tech knowledge."
      },
      {
        position: "Detection Specialist",
        company: "Stealth Monitoring",
        date: "2020 - 2023",
        details: "Monitored sites via video feeds, identified camera issues, and ensured operational reliability."
      }
    ].map((exp, index) => (
      <div key={index} className="md:flex md:items-start md:gap-6 relative">
        <div className="absolute -left-[9px] top-2 w-4 h-4 bg-violet-600 rounded-full border-2 border-white"></div>
        ...
        {/* Right side */}
        <div className="md:w-2/3 mt-2 md:mt-0 text-gray-700">
          {exp.details}
        </div>
      </div>
    ))}
