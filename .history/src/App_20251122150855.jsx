        ...
        >
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center max-w-6xl w-full">
            ...
            <div className="text-center lg:text-left space-y-4 order-2 lg:order-1">
              ...
              <p className="font-orbitron font-semibold text-[30px] lg:text-[30px] mb-4 text-center">A Web Developer</p>

              <div className="flex flex-col sm:flex-row gap-4 mt-4 justify-center">
                <button className="px-4 py-3 bg-[#2E186A] text-white text-lg font-semibold rounded-lg shadow hover:bg-[#ff6700] transition tracking-widest font-orbitron">
                  VIEW PROJECTS
                </button>
                <button className="px-4 py-3 bg-transparent border border-[#2E186A] text-[#2E186A] text-xs font-semibold rounded-lg shadow dark:hover:bg-[#ff6700] dark:hover:text-white transition tracking-widest font-orbitron">
                  CONTACT ME
                </button>
              </div>
            </div>
