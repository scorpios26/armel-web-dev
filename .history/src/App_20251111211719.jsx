          ...
          <div className="max-w-5xl w-full space-y-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-10 items-start">
              ...
              <div className="md:text-right">
                ...
                <p className="text-gray-500 dark:text-gray-600">Maven Solutions</p>
                <span className="text-sm text-gray-600">Jan 2024 – Jun 2024</span>
              </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 md:gap-10 items-start">
              ...
              <div className="md:text-right">
                ...
                <p className="text-gray-500 dark:text-gray-600">Stealth Monitoring</p>
