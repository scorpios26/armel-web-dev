  ...
  return (
    ...
    >
      ...
      <main className="px-8 lg:px-30 text-center">
        ...
        >
          <h2 className="text-4xl lg:text-5xl font-bold mb-16 font-orbitron text-[#2E186A] dark:text-[#2E186A]">
            Work Experience
          </h2>
          ...
          <div className="max-w-5xl w-full space-y-12">
            ...
            {/* Experience Item 2 */}
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 lg:gap-10 items-start">
              {/* Left Side */}
              <div className="md:text-right">
                <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-200">
                  Detection Specialist
                </h3>
                <p className="text-gray-500 dark:text-gray-400">Stealth Monitoring</p>
