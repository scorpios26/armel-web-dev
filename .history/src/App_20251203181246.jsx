...
import Loading from "./assets/components/Loading.json";
...
function App() {
 ...
 useEffect(() => {
  const timer = setTimeout(() => setFadeOut(true), 1500); // show loader 1.5s
  return () => clearTimeout(timer);
}, []);

if (loading) {
  return <Loader fadeOut={fadeOut} onAnimationEnd={() => setLoading(false)} />;
}
