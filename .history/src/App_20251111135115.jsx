          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center max-w-6xl w-full">
            ...
            <div className="text-center lg:text-left space-y-4 order-2 lg:order-1">
              ...
              <div className="flex flex-col sm:flex-row gap-4 mt-4 justify-center">
                ...
                <button className="px-6 py-3 bg-transparent border border-[#2E186A] text-[#2E186A] text-sm font-light rounded-lg shadow dark:hover:bg-purple-950 dark:hover:text-white transition">
                  Contact Me
                </button>
              </div>
            </div>
