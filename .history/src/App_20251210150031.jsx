...
function App() {
  ...
  className="transition-all duration-300 ease-in-out -m-2.5 inline-flex items-center justify-center rounded-md p-2.5 
             text-gray-600 dark:text-[#2E186A] hover:bg-gray-100 dark:hover:bg-gray-800 
