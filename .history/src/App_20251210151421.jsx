...
function App() {
  ...
  {mobileMenuOpen && (
    <motion.div
      ...
      className="fixed inset-y-0 right-0 w-64 bg-white dark:bg-gray-900 shadow-lg z-50 p-6"
    >
      {/* Close button */}
      <button
      ...
      {/* Menu items */}
      <nav className="mt-10 space-y-6 text-lg font-semibold text-gray-700 dark:text-gray-200">
