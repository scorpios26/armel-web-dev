...
function App() {
 ...
 useEffect(() => {
  // Simulate page loading — you can remove setTimeout later
  const timer = setTimeout(() => {
    setFadeOut(true);          // Start fade animation
    setTimeout(() => {
      setLoading(false);       // Hide loader completely
    }, 600); // match fadeOut duration in tailwind
  }, 1500); // how long loader stays visible before fade
          ...
          >
            <div className="flex items-center justify-between">
              ...
              >
                ...
                <XMarkIcon aria-hidden="true" className="h-6 " />
              </button>
            </div>
            <div className="mt-6">
