          ...
          <div className="max-w-5xl w-full space-y-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-10 items-start">
              ...
              <div className="md:text-right">
                <h3 className="text-xl font-semibold text-[#2E186A] dark:text-[#2E186A]">
                  Junior Web Developer
                </h3>
                <p className="text-gray-400">Maven Solutions</p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 md:gap-10 items-start">
              {/* Left Side */}
              <div className="md:text-right">
                <h3 className="text-xl font-semibold text-[#b46408] dark:text-[#df7804]">
                  Detection Specialist
                </h3>
                <p className="text-gray-400">Stealth Monitoring</p>
