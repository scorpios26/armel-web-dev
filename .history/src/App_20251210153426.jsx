  ...
  return (
    ...
    >
      <header className="absolute inset-x-0 top-0 z-50">
        ...
        ${
          isDarkMode ? "bg-[#2E186A] text-white" : "bg-[#f2f2f3] text-[#2E186A]"
        }`}
              >
                <div className="flex items-center justify-between">
                  ...
                  <button
                    ...
                    className={`-m-2.5 rounded-md p-2.5 bg-transparent hover:bg-gray-200 dark:hover:bg-[#3b2f6b]
             active:scale-95 transition-all duration-200 ease-in-out shadow hover:shadow-lg ${
                      isDarkMode ? "text-gray-200" : "text-[#2E186A]"
                    }`}
                  >
                    <span className="sr-only">Close menu</span>
                    <XMarkIcon className="h-6 w-6 transition-colors duration-200 group-hover:text-[#ff6700]" />
                  </button>
                </div>
                <div className="mt-6">
