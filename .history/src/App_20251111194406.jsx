      ...
      <main className="px-8 lg:px-30 text-center">
        ...
        >
          ...
          <h2 className="text-4xl lg:text-5xl font-bold mb-25 mt-50 font-orbitron">
           ...
           {/* Left: Lottie Animation */}
            <div className="text-center lg:text-left space-y-4">
              <h2 className='text-3xl text-center'>Intern Web Developer & QA Tester</h2>
             <p className="text-md leading-relaxed text-center">
                  Maven Solutions <br></br>
            ...
            {/* Right: Paragraph */}
            <div className="text-center lg:text-left space-y-4">
              <li className='text-left'>Design and develop website using Wordpress</li>
              <li className='text-left'>Test and debug web applications to ensure functionality and performance</li>
            </div>
            </div>
        </section>
